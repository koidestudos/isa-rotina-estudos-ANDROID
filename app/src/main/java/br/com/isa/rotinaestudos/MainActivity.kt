...
import br.com.isa.rotinaestudos.ui.components.IsaFabStack
import br.com.isa.rotinaestudos.ui.components.IsaGamificationHeader
import br.com.isa.rotinaestudos.ui.components.IsaPillTabRow
...
import br.com.isa.rotinaestudos.ui.screens.ViewUserProfileSheet
...
import br.com.isa.rotinaestudos.ui.screens.RevisionsScreen
import br.com.isa.rotinaestudos.ui.screens.ShopScreen
import br.com.isa.rotinaestudos.ui.screens.StudyTimerScreen
...
fun IsaApp(vm: IsaViewModel = viewModel()) {
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        ViewUserProfileSheet(state.viewedUser, vm::closeViewedUser)
...
private fun MainShell(
    ...
    val primaryTabs = MainTab.entries
    ...
    Box(Modifier.fillMaxSize()) {
        Column(Modifier.fillMaxSize()) {
            ...
            AnimatedContent(
                ...
                when (tab) {
                    ...
                    MainTab.REVISOES -> RevisionsScreen(state.revisions)
        ...
        Box(Modifier.align(Alignment.BottomEnd)) {
            IsaFabStack(
                onCalendar = { vm.openOverlay(OverlaySheet.CALENDARIO) },
                onTips = { vm.openOverlay(OverlaySheet.DICAS) },
                onAvisos = { vm.openOverlay(OverlaySheet.AVISOS) },
                onShop = { vm.openOverlay(OverlaySheet.LOJA) },
                onNotas = { vm.openOverlay(OverlaySheet.NOTAS) },
                onTimer = { vm.openOverlay(OverlaySheet.TIMER) }
            )
        }
...
private fun SettingsSheet(
    ...
    val systemDark = isSystemInDarkTheme()
    var showPassword by remember { androidx.compose.runtime.mutableStateOf(false) }
    Column(Modifier.verticalScroll(rememberScrollState())) {
        ...
        TextButton(onClick = { vm.openOverlay(OverlaySheet.FLASHCARDS) }, modifier = Modifier.padding(vertical = 4.dp)) {
            Text("🃏 Flashcards")
        }
        if (state.isAdmin) {
